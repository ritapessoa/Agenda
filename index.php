...
<div class="container">
                ...
                <?php foreach ($contacts as $contact) : ?>
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <a href="<?php echo $BASE_URL ?>edit.php?id=<?php echo $contact['id'] ?>"><i class="fas fa-edit edit-icon"></i></a>
    ...
    <?php else : ?>
        <p id="empty-list-text">Ainda não há contatos na sua agenda, <a href="<?php echo $BASE_URL ?>
